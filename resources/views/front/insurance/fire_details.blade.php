...
<section id="car-insurance-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="images">
                    <img src="{{ asset('front_assets/images/Insurance/fire-insurance.png') }}" alt="" class="img-fluid" width="400" height="400">
                </div>
            </div>
            <div class="col-lg-6 my-auto">
                ...
                <div class="add-cart-btn ">
                    <button href="#" class="buy-qr-btn getQuote" data-alias="fire-insurance" data-name="Fire Insurance">
                        Get Quote
                    </button>
                </div>
            </div>
