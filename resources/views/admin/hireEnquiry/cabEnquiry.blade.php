    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Cab Enquiry Details</h5>
...
@section('script')
<script rel="preload" src="{{ asset('admin_assets/js/custom/cab_enquiry.js') }}" as="script"></script>
@endsection
